    ...
    <div class="search-page">
      <div class="search-header">
        ...
        <div class="search-query">
          ...
          <div class="search-count" *ngIf="searchResults.length">
        ...
        <ng-template #noResultsTpl>
          <div class="no-results">
            <div class="no-results-content">
              ...
              <p>We couldn't find any files matching "{{ searchQuery }}"</p>
...
export class SearchComponent implements OnInit {
  ...
  get sortedResults(): FileItem[] {
    return this.fileService.sortFiles(this.searchResults, this.sortOption);
  }
  ...
  performSearch(): void {
    ...
    if (this.searchQuery.trim()) {
      this.fileService.searchFiles(this.searchQuery).subscribe(results => {
